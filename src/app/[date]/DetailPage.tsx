...
export const DetailPage = ({ date }: { date: string }) => {
  ...
  useGsap(containerRef.current, (gsap) => {
    ...
    return (
      ...
      >
        <div className="absolute inset-0 z-0">
          <DetailPageAnimation isIdle={false} />
        </div>
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <DetailPageAnimation isIdle={true} />
      </div>
      <h1 id="title" className="mt-auto text-6xl font-bold z-10 opacity-0">
